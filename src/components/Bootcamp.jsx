...
// day board instead of becoming a fourth column on it.
const meeting = [
      ...
      <div className="relative mx-auto max-w-[1800px]">
        <div className="grid lg:grid-cols-12 gap-x-10 gap-y-8 items-end">
          <div className="lg:col-span-7">
            ...
            >
              Three days that build an engineer
            </motion.h2>
          </div>
          ...
          >
            ...
            All three days are behind us — the finale is next.
          </motion.p>
        </div>

        {/* Day board */}
        <div className="mt-14 lg:mt-20 grid grid-cols-1 sm:grid-cols-3 gap-y-12 lg:gap-y-0">
          {days.map((day, i) => {
            ...
            return (
              ...
              >
                ...
                <h3 className="mt-4 font-display font-semibold text-lg lg:text-xl tracking-[-0.03em] max-w-[16ch]">
                  {day.title}
                </h3>
        ...
        >
          <span className="absolute inset-y-0 left-0 w-[3px] bg-moss" aria-hidden />

          <div className="grid lg:grid-cols-12 gap-x-10 gap-y-7 px-6 sm:px-9 lg:px-10 py-7 sm:py-9">
            <div className="lg:col-span-4">
              <span className="inline-flex items-center gap-2 border border-moss/45 rounded-full pl-2.5 pr-3 py-1 eyebrow-bare text-moss">
            ...
            <div className="lg:col-span-7 lg:col-start-6">
              <p className="max-w-[56ch] text-[14.5px] sm:text-[15px] leading-relaxed text-ink-soft">
                The technical team sat down with each team to look at the robot they had built so
                far &mdash; whatever state it was in, half-built and not yet working included.
              </p>
